...
public class CellSubGraphBasic {
    /*
    cell graphs
    ...
    public CellSubGraphBasic(int argumentOfW1, List<Quintuple<Integer, SymbolicWeight, SymbolicWeight, Integer, SymbolicWeight>> c5, List<Triple<Integer, Integer, SymbolicWeight>> e3, List<Triple<Integer, SymbolicWeight, SymbolicWeight>> l3, Collection<SymbolicWeight> weights) {
        this.argumentOfW1 = argumentOfW1;
        this.c5 = c5;
        this.e3 = e3;
        this.l3 = l3;
...
//            literals.add("L(" + mapping.toNode(triple.r) + "," +
    ...
    public static CellSubGraphBasic create(String sub) {
...
//        System.out.println(Clause.parse(sub, ',', null));
        int argumentOfW1 = 0;
        ...
        return new CellSubGraphBasic(argumentOfW1, c5, e3, l3, cache.values());
    }
